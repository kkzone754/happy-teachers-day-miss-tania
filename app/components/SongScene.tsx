  ...
  return (
    <section ref={root} className="relative h-screen min-h-[760px] overflow-hidden bg-[#050403] text-white">
      ...
      <div className="song-detail absolute left-[12%] top-[25%] z-20 w-[470px]">
        ...
        <h3 className="mt-5 font-serif text-4xl leading-tight text-white/95">I showed you the song I had created.</h3>
        <p className="mt-6 font-sans text-base leading-8 text-white/50">You listened to it, and your reaction made me genuinely happy.</p>
      </div>
      ...
      <div className="song-opportunity absolute right-[11%] top-[34%] z-20 w-[390px] border-l border-[#d9a64c]/35 pl-7">
        ...
        <p className="mt-5 font-serif text-2xl leading-9 text-white/80">You appreciated the song — and you appreciated the effort behind it.</p>
        <p className="mt-4 font-sans text-sm leading-7 text-white/40">That appreciation genuinely made me happy and gave me a new kind of motivation.</p>
        <p className="mt-5 font-serif text-xl leading-8 text-[#d9a64c]/85">It made me want to keep going, keep learning, and keep getting better.</p>
      </div>
      ...
      <div className="song-ending absolute left-1/2 top-[34%] z-30 w-[760px] max-w-[82vw] -translate-x-1/2 text-center">
        ...
        <h3 className="mt-7 font-serif text-5xl leading-tight tracking-[-0.035em] text-white/95">Your appreciation gave me a reason to believe in my own work.</h3>
        <p className="mx-auto mt-7 max-w-2xl font-serif text-2xl leading-10 text-[#d9a64c]/85">And that little spark stayed with me.</p>
        <p className="mx-auto mt-6 max-w-xl font-sans text-sm leading-7 text-white/40">Sometimes, a few encouraging words are enough to make someone want to do better.</p>
      </div>
